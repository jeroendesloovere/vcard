...
### Example Multiple VCard

You can generate multiple VCard by adding ```new``` method between each contact
...
// add work data
$vcard->addCompany('WewAjalah');
$vcard->addJobtitle('Designer');
$vcard->addEmail('woy@alakadut.online');
$vcard->addPhoneNumber(784999377, 'PREF;WORK');
$vcard->addPhoneNumber(288474755, 'WORK');
$vcard->addAddress(null, null, 'street', 'worktown', null, 'workpostcode', 'Belgium');
$vcard->addURL('http://www.alakadut.online');
