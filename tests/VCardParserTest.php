...
namespace Dilone\VCard\tests;

use Dilone\VCard\VCard;
use Dilone\VCard\VCardParser;
...
class VCardParserTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $vcard = new VCard();
        $vcard->addUrl('http://www.Dilone.be');
        ...
        $parser = new VCardParser($vcard->buildVCard());
        $this->assertEquals($parser->getCardAtIndex(0)->url['default'][0], 'http://www.Dilone.be');
    ...
    public function testLogo()
    {
        ...
        $imageUrl = 'https://raw.githubusercontent.com/Dilone/vcard/master/tests/image.jpg';
    ...
    public function testFromFile()
    {
        ...
        // example file.
        $this->assertEquals($cards[0]->url['default'][0], 'http://www.Dilone.be');
